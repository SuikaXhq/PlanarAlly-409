...
const navigationTranslation: Record<Navigation, string> = {
    [Navigation.Play]: "游玩",
    [Navigation.Run]: "运作",
    [Navigation.Create]: "创建",
    [Navigation.Import]: "导入",
    [Navigation.Settings]: "设置",
    [Navigation.AssetManage]: "管理",
    [Navigation.AssetCreate]: "创建",
    [Navigation.Logout]: "登出帐号",

    [Navigation.Account]: "帐号设置",
    [Navigation.Back]: "返回",
};
...
<template>
    <div id="page">
        ...
        <div v-else id="not-implemented">
            ...
            <div class="padding bold">噢！你踏入了未知领域！</div>
            <div>这个功能还在开发之中</div>
            <div>之后再来吧！</div>
        </div>
